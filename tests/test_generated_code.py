...
def test_render_contains_header_comment() -> None:
    ...
    assert rendered.startswith("/* Generated by regex-cgen – do not edit. */")
...
def test_render_sections_order(pattern: str, kwargs: dict) -> None:
    ...
    header_pos = rendered.index("/* Generated by regex-cgen")
    # Find first include
